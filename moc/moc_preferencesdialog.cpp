...
static const char qt_meta_stringdata_PreferencesDialog[] = {
    "PreferencesDialog\0\0on_browseLDraw_clicked()\0"
    "on_browsePli_clicked()\0on_browseLDView_clicked()\0"
    "on_browseLDGLite_clicked()\0"
};
...
void PreferencesDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_browseLDraw_clicked(); break;
        case 1: _t->on_browsePli_clicked(); break;
        case 2: _t->on_browseLDView_clicked(); break;
        case 3: _t->on_browseLDGLite_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
